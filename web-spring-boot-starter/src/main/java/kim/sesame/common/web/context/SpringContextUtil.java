...
public class SpringContextUtil extends SpringUtil {
    ...
    public static void printStartInfo(String ip){
        ...
        String active = getProperty("spring.profiles.active");
        String port = getProperty("server.port");
        String path = getProperty("server.servlet.context-path");
...
//public class SpringContextUtil extends ApplicationContextAware {
